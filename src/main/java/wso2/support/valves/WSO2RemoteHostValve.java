...
public final class WSO2RemoteHostValve extends RequestFilterValve {

    private static final Log log = LogFactory.getLog(WSO2RemoteHostValve.class);
    ...
    public void invoke(Request request, Response response)
        ...
        log.info("========== WSO2 Support : Remote Host is : " + property);
        log.info("========== WSO2 Support : Remote IP is : " + request.getRequest().getRemoteAddr());
